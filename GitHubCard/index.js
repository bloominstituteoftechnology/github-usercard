...
console.log(axios.get('https://api.github.com/users/RockoGilbert'))
...
const followersArray = ["tetondan","dustinmyers","justsml","luishrd","bigknell","bigknell"];

followersArray.forEach(item => {

  axios.get('https://api.github.com/users/'+item)
  .then(response => div.appendChild(GitCard(response)))
