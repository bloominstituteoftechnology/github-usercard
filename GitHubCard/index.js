...
*/
// axios
//   .get('https://cors-anywhere.herokuapp.com/https://api.github.com/users/cohengus').then(response => {
...
axios.get('https://cors-anywhere.herokuapp.com/https://api.github.com/users/cohengus').then(response => {
  console.log('API RESPONSE', response)
...
followersArray.forEach(follower => {
  axios.get(`https://cors-anywhere.herokuapp.com/https://api.github.com/users/${follower}`)
    .then(response => {
      console.log('API RESPONSE', response)
