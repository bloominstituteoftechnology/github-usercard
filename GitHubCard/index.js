...
*/
axios
  .get("https://api.github.com/users/Ryan-Erickson")
  .then(response => {
...
axios.get('https://api.github.com/users/Ryan-Erickson').then(response => {
...
//My Follower's Cards
// axios.get(`https://api.github.com/users/Ryan-Erickson/followers`)
//   .then(response => {
