...
*/
let gitHubUser = axios.get("https://api.github.com/users/arkstreett")
...
const followersArray = ["arkstreett", "tetondan", "dustinmyers", "justsml", "luishrd", "bigknell"];

followersArray.forEach(item => {
  axios.get("https://api.github.com/users/" + item)
  .then(response => {
    document.querySelector(".cards").appendChild(UserCardComponent(response));
  })
});
...
function UserCardComponent(githubData) {
