...
*/
function cardMaker({url, name, login, location, html, userFollowers, userFollowing, bio}){
...
//structuring
  ...
  cardProfile.appendChild(address);
//adding classes
...
//adding data
  ...
  address.setAttribute('href', `${html}`);
