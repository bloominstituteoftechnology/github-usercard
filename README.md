...
* [ ] Add your team lead as collaborator on Github.-N/A
...
* [ ] Implement the project on your newly created `<firstName-lastName>` branch, committing changes regularly. - WIP
* [ ] Push commits: git push origin `<firstName-lastName>`. -Not Yet
...
* [ ] Navigate to the root of the project with your command line. -ok
* [ ] Run `npm install` to download any dependencies listed in the `package.json` file. -ok
* [ ] Run `npm start` to compile your project and launch a development server. -ok
...
* [ ] Run `npm install axios` to download the dependency (it will be added to the `package.json` file). -ok
* [ ] At the top of the `GitHubCard/index.js` file, type `import axios from 'axios';`-ok

### Part 1: Requesting Data from the GitHub API
- I'm not sure what this is asking or where to start, can't seem to make the connection between the guided project and this
