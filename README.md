...
- [Github User Card](#github-user-card)
  ...
  - [Set Up The Project With Git](#set-up-the-project-with-git)
    ...
    - [Axios Setup](#axios-setup)
      - [Option 1 (adding Axios via script element)](#option-1-adding-axios-via-script-element)
      - [Option 2 (installing Axios with npm)](#option-2-installing-axios-with-npm)
    - [Part 1: Requesting Data from the GitHub API](#part-1-requesting-data-from-the-github-api)
